namespace Morpeh.TestSuite.Editor {
    ...
    public static class Utils {
        public static MAllocatingCountGCMemoryConstraint AllocatingCountGCMemory(this ConstraintExpression chain, int maxLimit) {
            var memoryConstraint = new MAllocatingCountGCMemoryConstraint(maxLimit);
        ...
        /// </summary>
        public class MAllocatingCountGCMemoryConstraint : Constraint {
            private readonly int maxLimit;

            public MAllocatingCountGCMemoryConstraint(int maxLimit) {
